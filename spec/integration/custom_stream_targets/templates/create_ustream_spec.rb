...
describe "custom_stream_target .save ustream", :integration_test => true do
  
  name                    = "auto sdk save ustream"
  ...
  before :all do
    ...
    data = WscSdk::Templates::CustomStreamTarget.ustream(name, primary_url, stream_name)
