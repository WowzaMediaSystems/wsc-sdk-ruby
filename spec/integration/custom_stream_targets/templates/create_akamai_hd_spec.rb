...
describe "custom_stream_target .save akamai_hd", :integration_test => true do
  
  name                    = "auto sdk save akamai_hd"
  ...
  before :all do
    ...
    data = WscSdk::Templates::CustomStreamTarget.akamai_hd(name, primary_url, stream_name)
