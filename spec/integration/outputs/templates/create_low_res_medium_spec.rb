...
describe "output .save low_res_medium", :integration_test => true do
  
  t_name                  = "auto sdk save low_res_medium"
  name                    = "Video+Audio=512+128, baseline, 512 x 288"
  ...
  before :all do
    ...
    @data = WscSdk::Templates::Output.low_res_medium
