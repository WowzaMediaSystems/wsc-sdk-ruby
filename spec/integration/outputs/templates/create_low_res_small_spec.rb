...
describe "output .save low_res_small", :integration_test => true do
  
  t_name                  = "auto sdk save low_res_small"
  name                    = "Video+Audio=320+128, baseline, 320 x 180"
  ...
  before :all do
    ...
    @data = WscSdk::Templates::Output.low_res_small
